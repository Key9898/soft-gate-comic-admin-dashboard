...
const mockTransactions: Transaction[] = [
  ...
  },
  {
    ...
    coins: 50,
    status: 'completed',
    description: { en: 'Refund for duplicate purchase', mm: 'ထပ်နေသော ဝယ်ယူမှုအတွက် ငွေပြန်အမ်းခြင်း' },
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">Track revenue, manage transactions and payouts</p>
          </div>
          <Button
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-orange-600 mt-1">3 requests pending</p>
                  </div>
