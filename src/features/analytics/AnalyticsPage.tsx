...
import { Card, ProgressBar, PageSEO, EmptyState } from '../../components';
...
const AnalyticsPage = () => {
  ...
  void resolvedTheme;
  const { revenueData, userGrowthData, popularWebtoons, genres, users, webtoons, isLoading } =
    useData();
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-fg-muted">
                    {mock ? 'In selected range' : 'Not wired on live'}
                  </p>
                </div>
            ...
            <Card>
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-fg-muted">
                    {mock ? 'Current roster' : 'Not wired on live'}
                  </p>
                </div>
