...
import { Card, Button, Input, Modal, PageSEO, EmptyState } from '../../components';
                    ...
                    <tr key={report.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex gap-2">
                          ...
                          {canWriteCommunity && report.status === 'pending' && (
                            <>
                              <Button
                                size="sm"
                                variant="ghost"
          ...
          >
            {selectedReport && (
              <div className="space-y-4">
                ...
                {canWriteCommunity && selectedReport.status === 'pending' && (
