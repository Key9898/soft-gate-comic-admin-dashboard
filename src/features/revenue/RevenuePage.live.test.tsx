...
describe('RevenuePage live desk', () => {
  beforeEach(() => {
    localStorage.clear();
    seed();
  });

  it('does not leak mock buyers or purchase totals', () => {
    wrap();
    ...
    expect(screen.getAllByText('This desk has no payments API.').length).toBeGreaterThan(0);
  });
});
