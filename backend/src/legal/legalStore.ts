...
export type LegalStore = {
  getMeta: (doc: LegalDoc) => Promise<LegalMetaRecord>;
  upsertMeta: (doc: LegalDoc, input: LegalMetaRecord) => Promise<LegalMetaRecord>;
  listSections: (doc: LegalDoc) => Promise<LegalSectionRecord[]>;
  findSectionById: (doc: LegalDoc, id: string) => Promise<LegalSectionRecord | null>;
  createSection: (doc: LegalDoc, input: LegalSectionWrite) => Promise<LegalSectionRecord>;
  updateSection: (
    doc: LegalDoc,
    id: string,
    patch: LegalSectionPatch,
  ) => Promise<LegalSectionRecord | null>;
  deleteSection: (doc: LegalDoc, id: string) => Promise<boolean>;
};
